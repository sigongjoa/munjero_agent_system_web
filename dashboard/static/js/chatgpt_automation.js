document.addEventListener('DOMContentLoaded', () => {
    console.log("chatgpt_automation.js loaded and DOMContentLoaded fired.");
    ...
    const connectWebSocket = () => {
        ...
        ws.onmessage = (event) => {
            ...
            // Handle WebSocket messages specific to ChatGPT automation if any
        };
    ...
    // --- Image Generation from Script Logic ---
